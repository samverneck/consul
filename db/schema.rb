...
ActiveRecord::Schema.define(version: 20160608165105) do
  ...
  create_table "proceeding_line_proposals", force: :cascade do |t|
    t.integer  "line_id"
  ...
  add_index "proceeding_line_proposals", ["author_id"], name: "index_proceeding_line_proposals_on_author_id", using: :btree
  add_index "proceeding_line_proposals", ["line_id"], name: "index_proceeding_line_proposals_on_line_id", using: :btree
  add_index "proceeding_line_proposals", ["section_id"], name: "index_proceeding_line_proposals_on_section_id", using: :btree

  create_table "proceeding_line_sections", force: :cascade do |t|
    t.string   "name"
    t.integer  "line_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "proceeding_line_sections", ["line_id"], name: "index_proceeding_line_sections_on_line_id", using: :btree

  create_table "proceeding_lines", force: :cascade do |t|
  ...
  add_index "proceeding_lines", ["proceeding_id"], name: "index_proceeding_lines_on_proceeding_id", using: :btree
  ...
  add_foreign_key "proceeding_lines", "proceedings"
